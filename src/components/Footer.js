...
import Img1 from "../image/Logob.png"
export default function Footer() {
    return (
        <>
            <footer className="px-4 divide-y bg-[#6ede8a] text-black">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">HawkFolio</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center text-black">© 2023 Company Co. All rights reserved.</div>
            </footer>
