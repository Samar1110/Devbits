                        ...
                        <div className="p-6 xl:col-span-3">
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="grid content-center gap-4">
                                    ...
                                    <div className="p-6 rounded shadow-md bg-black">
                                        <p className="text-white">Stockfolio is my go-to platform for tracking my investments. The real-time data and analytics are incredibly helpful, and the interface is super easy to use. I also love the personalized alerts that keep me up-to-date on my portfolio.</p>
                                        <div className="flex items-center mt-4 space-x-4">
